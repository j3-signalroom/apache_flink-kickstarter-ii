...
| --- | --- | --- | --- |
| PTF UDF | Walks through building, deploying, and testing a stateful **ProcessTableFunction** that enriches Kafka events with per-user session tracking. | [CP Java Example](examples/ptf_udf/cp_java/README.md) <br> [CP Python Example?](docs/ptf-udf-python-support.md) | [CC Java Example](examples/ptf_udf/cc_java/README.md) <br> [CC Python Example?](docs/ptf-udf-python-support.md) |
