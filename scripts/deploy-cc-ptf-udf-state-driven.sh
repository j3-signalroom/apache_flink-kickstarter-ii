...
#
# *** Script Syntax ***
# ./deploy-cc-ptf-udf-state-driven.sh=<create | destroy> --confluent-api-key=<CONFLUENT_API_KEY>
...
TERRAFORM_DIR="$(cd "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/../examples/ptf_udf_state_driven/cc_deploy" && pwd)"
