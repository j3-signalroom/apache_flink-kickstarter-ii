...
#
# *** Script Syntax ***
# ./deploy-cc-ptf-udf-timer-driven.sh=<create | destroy> --confluent-api-key=<CONFLUENT_API_KEY>
...
TERRAFORM_DIR="$(cd "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/../examples/ptf_udf_timer_driven/cc_deploy" && pwd)"
