...
The [`UserEventEnricher.java`](../examples/ptf_udf_state_driven/java/app/src/main/java/ptf/UserEventEnricher.java) is a PTF that takes a `user_events` table and enriches it, producing a dynamically defined output row:
