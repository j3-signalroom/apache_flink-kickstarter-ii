...
resource "confluent_service_account" "schema_registry_cluster_api" {
    display_name = "ptf_udf_cc_java_schema_registry_cluster_api"
...
module "schema_registry_cluster_api_key_rotation" {
    ...
    resource = {
        id          = data.confluent_schema_registry_cluster.ptf_udf_cc_java.id
        api_version = data.confluent_schema_registry_cluster.ptf_udf_cc_java.api_version
